 ...
 * Includes full track metadata + audio features for use in the recommender.
 *
 * Response: { tracks: Array<{ track_id, track_name, artist_name, genre_name,
 *   track_popularity, danceability, energy, valence, tempo, liked_at }> }
 */
